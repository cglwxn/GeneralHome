...
@interface FangPageViewController ()<UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate>

@property (strong, nonatomic) UIPageViewController *pageViewController;

@end

@implementation FangPageViewController
...
- (void)didSelectViewControllerAtIndex:(NSInteger)index {
    FangPageViewController * weakSelf = self;
