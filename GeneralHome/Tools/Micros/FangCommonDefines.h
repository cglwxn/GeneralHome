...
#define Fang_Universal_Link @"https://b6uh.t4m.cn/"
...
#define SCREEN_TOP_BAR_HEIGHT FIT_NAVIGATION_BAR_HEIGHT//顶部bar高度
...
#define FIT_NAVIGATION_BAR_HEIGHT 88.0f
...
#define FangiPhoneXSeries (FangiPhoneDEVICE && FangIOS11DEVICE && [UIApplication sharedApplication].keyWindow.safeAreaInsets.bottom > 0)

//iphoneX 1125x2436;
#define iPhoneX (FangiPhoneDEVICE && FangIOS11DEVICE && [UIApplication sharedApplication].keyWindow.safeAreaInsets.bottom > 0)

#define iPhoneMax (FangiPhoneDEVICE && FangIOS11DEVICE && [UIApplication sharedApplication].keyWindow.safeAreaInsets.bottom > 0)
